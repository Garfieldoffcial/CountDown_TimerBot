...
TELETIPS_MAIN_MENU_BUTTONS = [
            ...
            [
                InlineKeyboardButton('👨‍💻 DEVELOPER', url='https://t.me/Botprofficer)').
                InlineKeyboardButton('👥 CHANNEL', url='https://t.me/Dr_Stranger_Botz_Infinity'),
                InlineKeyboardButton('📣 GROUP', url='https://t.me/Dr_Stranger_Botz_Infinity_Chat')
            ]
        ]
